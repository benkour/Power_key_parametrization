...
# ============================================================
# 1) GRU FEATURE EXTRACTOR (returns an embedding, NOT a prediction)
# ============================================================
class GRUModel(nn.Module):
    ...
    def __init__(self, input_size=29, hidden_size=64, num_layers=2, bidirectional=True):
        ...
        # Optional projection head (helps GP sometimes)
...
# ============================================================
# 2) Exact GP that operates on extracted features (embeddings)
# ============================================================
...
# ============================================================
# 3) Wrapper model: GRU -> GP
# ============================================================
class GNNGP(gpytorch.Module):
    """
    ...
    def __init__(self, feature_extractor: nn.Module, likelihood, train_x, train_y, device=None):
        ...
        with torch.no_grad():
            init_features = self.feature_extractor(self.train_x)
    ...
    def forward(self, x):
        ...
        if self.training:
            ...
            train_features = self.feature_extractor(self.train_x)
